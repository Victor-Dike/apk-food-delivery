...
import 'package:food_delivery_app/veiw/main_tabveiw/main_tab_veiw.dart';
                ...
                children: pageArr.map((e) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      color: index == selectPage ? TColor.primary : 
                      TColor.placeholder,
                ...
                child: RoundButton(
                    ...
                    onPressed: () {
                      if (selectPage >= 2) {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const MainTabVeiw()),
                        );
                      } else {
                        // Home Screen
